function plotcrosssteps (t,j,fir,incr)
...
varname = ['step_' n];
filename = ['C:\Quicksand\Output\' varname '.mat'];
...
if exist('C:\Quicksand\Output\surface.mat') == 2
    load C:\Quicksand\Output\surface.mat
end
if exist('C:\Quicksand\Output\xcentroids.mat') == 2
    load C:\Quicksand\Output\xcentroids.mat
end
if exist('C:\Quicksand\Output\zcentroids.mat') == 2
    load C:\Quicksand\Output\zcentroids.mat
end
if exist('C:\Quicksand\Output\strat.mat') == 2
    load C:\Quicksand\Output\strat.mat
end
if exist('C:\Quicksand\Output\celldim.mat') == 2
    load C:\Quicksand\Output\celldim.mat
end
if exist('C:\Quicksand\Output\SL.mat') == 2
    load C:\Quicksand\Output\SL.mat
end
...
if t == 1 
    for i = 1:L
        for k = 1:N
            ...
            if val == 0 
                if overallmaxz - k .* celldim(3,j) >= 0 
                    tract(k,i) = 1; %air
                else
                    tract(k,i) = 2; % water
                end
    ...
    for i = 1:L
        for k = 1:N
            ...
            if val == 0 
                ...
                if overallmaxz - k .* celldim(3,j) >= SL(t-1,j)  
                    tract(k,i) = 1; %air
                else
                    tract(k,i) = 2; % water
                end
