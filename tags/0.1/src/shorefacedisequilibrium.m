...
global equil;
global celldim; 
global xcentroids; % temp variable
...
for i = 1:icrest - 1    
    ...
    if disequilibrium(i) < 0
        [tempgrid,ztally] = accrete(tempgrid,disequilibrium,t,i,j,shorewidthratio);        
    end
...
ztally = 0;
    ...
    if disequilibrium(icrest) < 0
        [tempgrid,ztally] = accrete(tempgrid,disequilibrium,t,icrest,j,shorewidthratio);
    end
